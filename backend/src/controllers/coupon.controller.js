coupon_controller = '''const { Coupon, Order } = require('../models');
...
with open("/mnt/kimi/output/foodflow-ecosystem/backend/src/controllers/coupon.controller.js", "w") as f:
f.write(coupon_controller)
