admin_controller = '''const { User, Restaurant, Order, DeliveryAgent, Coupon } = require('../models');
...
with open("/mnt/kimi/output/foodflow-ecosystem/backend/src/controllers/admin.controller.js", "w") as f:
