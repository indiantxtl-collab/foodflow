restaurant_routes = '''const express = require('express');
...
with open("/mnt/kimi/output/foodflow-ecosystem/backend/src/routes/restaurant.routes.js", "w") as f:
f.write(restaurant_routes)
